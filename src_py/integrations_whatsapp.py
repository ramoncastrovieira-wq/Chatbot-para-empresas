...
class WhatsAppGateway:
    """Gateway profissional para integração com WhatsApp Cloud API/Business API"""
    
    def __init__(self, business_account_id: str, access_token: str, webhook_token: str, phone_number_id: str | None = None):
        self.business_account_id = business_account_id
        self.phone_number_id = phone_number_id or business_account_id
    ...
    def parse_webhook_message(self, webhook_data: Dict[str, Any]) -> Optional[WhatsAppMessage]:
        ...
        try:
            ...
            contact_name = contacts[0].get("profile", {}).get("name") or from_phone
            ...
            return WhatsAppMessage(
                ...
                media_url=media_url,
                metadata={"raw": msg_data, "contact_name": contact_name}
            )
            ...
            if msg:
                ...
                try:
                    result = process_demo_chat(
                        ...
                        name=(msg.metadata or {}).get("contact_name", msg.from_phone),
                        content=msg.content,
                    )
