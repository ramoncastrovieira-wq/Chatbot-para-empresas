    ...
    if request.method == "POST":
        try:
            ...
            if msg:
                ...
                # TODO: Processar mensagem (salvar no banco, enviar para IA, etc)
                # from src_py.services import get_conversation_service, get_message_service
                # contact_service.get_or_create_contact(msg.from_phone, ...)
                # conversation = conversation_service.get_or_create_conversation(contact_id)
                # await message_service.process_incoming_message(...)
